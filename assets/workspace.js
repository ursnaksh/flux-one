...
for (const name of ['saveStudentProfile', 'saveNewNote', 'deleteNote', 'toggleAssignment', 'toggleTopic', 'saveAssignment', 'nextQuizQuestion', 'toggleActivityCapture', 'startStudySession', 'pauseStudySession', 'resumeStudySession', 'openSessionReflection', 'saveCompletedStudySession']) {
